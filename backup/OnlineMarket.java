...
public class OnlineMarket {
            ...
            if (selectOne.equals("c")) {
                ...
                if (deletingCategory.equals("c")) {
                    ...
                    for (int i = 1; i <= categories.size(); i++) {
                        if (categories.get(i).getName().equals(namesOfCategories[deleteCat - 1])) {
                            categories.put(i, null);
                        }
                    }
                    namesOfCategories[deleteCat - 1] = null;
                    for (int size = products.size() - 1; size >= 0; size--) {
                        if (products.get(size).getCategory().getName().equals(namesOfCategories[deleteCat - 1])) {
                ...
                if (Character.isLetter(c)) {
                    ...
                    while (true) {
                        ...
                        if (selectOneProd.equals("l")) {
                            for (int size = products.size() - 1; size >= 0; size--) {
                                if (products.get(size).getCategory().getName().equals(namesOfCategories[selectOneProduct - 1])) {
                                    products.remove(size);
                                }
                            }
                            System.out.println("successfully removed!!");
    ...
    private static void productInfos(int choiceCommand) {
        ...
        for (int i = 0; i < products.size(); i++) {
            if (products.get(i).getCategory().getName().equals(namesOfCategories[choiceCommand - 1])) {
                notFound = false;
    ...
    private static void categoryList() {
        if (categories.size() == 0) {
            ...
            while (iterator.hasNext()) {
                namesOfCategories[count] = iterator.next();
                count++;
            }
            for (int i = 0; i < namesOfCategories.length; i++) {
                if (namesOfCategories[i] != null) {
                    System.out.println(i + 1 + "-" + namesOfCategories[i]);
                }
            }
            System.out.println("----------------------------------------");
        }
